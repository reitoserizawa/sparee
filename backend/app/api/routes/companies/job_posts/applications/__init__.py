...
from .get_application_history import router as get_application_history_router
...
router.include_router(get_application_history_router,
                      prefix="/{application_id}/history", tags=["job-applications"])
