...
from app.schemas.job_applications import SimpleJobApplicationResponseModel, JobApplicationCreateModel
...
@router.post("/", status_code=201, response_model=SimpleJobApplicationResponseModel)
