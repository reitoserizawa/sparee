...
Revision ID: e4f2c3567185
Revises: 1efda5621113
Create Date: 2026-02-05 17:42:22.845304
...
revision = 'e4f2c3567185'
down_revision = '1efda5621113'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    op.create_table('job_posts',
                    sa.Column('id', sa.INTEGER(), server_default=sa.text(
                        "nextval('job_posts_id_seq'::regclass)"), autoincrement=True, nullable=False),
                    ...
                    sa.Column('deleted_at', postgresql.TIMESTAMP(
                        timezone=True), autoincrement=False, nullable=True),
                    sa.ForeignKeyConstraint(
                        ['address_id'], ['addresses.id'], name='job_posts_address_id_fkey'),
                    sa.ForeignKeyConstraint(
                        ['company_id'], ['companies.id'], name='job_posts_company_id_fkey'),
                    sa.ForeignKeyConstraint(['job_category_id'], [
                        'job_categories.id'], name='job_posts_job_category_id_fkey'),
                    sa.PrimaryKeyConstraint('id', name='job_posts_pkey'),
                    postgresql_ignore_search_path=False
                    )
